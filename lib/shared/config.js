...
const config = {
  ...
  INGRESS_CONTROLLER_NAMESPACE: process.env.INGRESS_CONTROLLER_NAMESPACE || 'default,kube-system',
  INGRESS_CONTROLLER_ENDPOINT: process.env.INGRESS_CONTROLLER_ENDPOINT || 'ingress-nginx,traefik',
