...
class KsAgent {
  ...
  async findIngresses() {
    ...
    if (this.k8sClient.apis[baseApi] && this.k8sClient.apis[baseApi][ingVersion])
    ...
    if (this.ingressApi) {
      ...
      logger.error(
        'Unable to find Ingress support in this Kubernetes cluster! Please report this issue to KubeSail! https://gitter.im/KubeSail'
      )
    }
  }
