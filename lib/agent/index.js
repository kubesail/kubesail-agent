...
class KsAgent {
  ...
  async collectMetrics() {
    ...
    try {
      ...
      if (err.code === 503) {
        logger.silly('collectMetrics: metrics server unavailable (503)')
      } else {
    ...
    metrics = [
      {
        metadata: {
          name: 'pasadena-ryzen',
          creationTimestamp: '2022-04-08T20:07:20Z',
          labels: {
            'beta.kubernetes.io/arch': 'amd64',
            'beta.kubernetes.io/instance-type': 'k3s',
            'beta.kubernetes.io/os': 'linux',
            'kubernetes.io/arch': 'amd64',
            'kubernetes.io/hostname': 'debian11.localdomain',
        ...
        timestamp: '2022-04-08T20:07:02Z',
        window: '10s',
        usage: {
          cpu: '155600u',
          memory: '1473572Ki'
