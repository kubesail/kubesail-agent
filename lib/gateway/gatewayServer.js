...
module.exports = function () {
  ...
  server.post('/agent/verify/:secret', async (req, res) => {
    ...
    await this.addAgentSocketMapping({ agentKey, clusterAddress, domains: { clusterAddress: 0 } })
  ...
  server.put('/agent/:secret/:agentKey', async (req, res) => {
    ...
    logger.info('Got update to config', { agentKey, domains: firewall })
    await this.addAgentSocketMapping({ agentKey, domains: firewall })
