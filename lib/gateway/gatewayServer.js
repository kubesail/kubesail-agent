...
module.exports = function() {
  ...
  server.put('/agent/watch/:startOrStop/:secret', async (req, res) => {
    ...
    const { username, agentKey, resourcesToWatch } = req.body
    this.agentRegistrationSocketServer
      .to(agentKey)
      .emit('kube-watch', { username, startOrStop, resourcesToWatch })
    logger.info('Emitting kube-watch request to agent', { username, startOrStop, resourcesToWatch })
    res.sendStatus(202)
  })
