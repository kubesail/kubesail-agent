...
class KsGateway {
  ...
  addSocketMapping = async (socketId /*: Socket */, validDomains /*: Array<string> */) => {
  ...
  init = async () => {
    ...
    this.remoteJoin = util.promisify(this.agentRegistrationSocketServer.of('/').adapter.remoteJoin)
